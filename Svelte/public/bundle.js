var app = (function () {
    ...
    /* TabButton.svelte generated by Svelte v3.48.0 */
    const file = "TabButton.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*selected, id*/ 6 && button_class_value !== (button_class_value = "" + (null_to_empty(/*selected*/ ctx[1] ? 'selected' : { id: /*id*/ ctx[2] }) + " svelte-tj0xqo"))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [name, selected, id, onClick, click_handler];
    }

    class TabButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { name: 0, selected: 1, id: 2, onClick: 3 });
    		...
    		if (/*name*/ ctx[0] === undefined && !('name' in props)) {
    			console.warn("<TabButton> was created without expected prop 'name'");
    		}

    		if (/*selected*/ ctx[1] === undefined && !('selected' in props)) {
    			console.warn("<TabButton> was created without expected prop 'selected'");
    		}

    		if (/*id*/ ctx[2] === undefined && !('id' in props)) {
    			console.warn("<TabButton> was created without expected prop 'id'");
    		}
    	}
    ...
    /* TabArea.svelte generated by Svelte v3.48.0 */

    const file$1 = "TabArea.svelte";
    ...
    class TabArea extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*content*/ ctx[0] === undefined && !('content' in props)) {
    			console.warn("<TabArea> was created without expected prop 'content'");
    		}
    	}
    ...
    /* Tabs.svelte generated by Svelte v3.48.0 */
    const file$2 = "Tabs.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	tabbutton = new TabButton({
    			props: {
    				id: /*i*/ ctx[6],
    				name: /*tab*/ ctx[4].name,
    				selected: /*selected*/ ctx[1] === /*i*/ ctx[6]
    			},
    			$$inline: true
    		});

    	tabbutton.$on("selection", /*selection_handler*/ ctx[3]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*tabs*/ 1) tabbutton_changes.name = /*tab*/ ctx[4].name;
    			if (dirty & /*selected*/ 2) tabbutton_changes.selected = /*selected*/ ctx[1] === /*i*/ ctx[6];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:4) {#each tabs as tab, i}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	tabarea = new TabArea({
    			props: {
    				content: /*tabs*/ ctx[0][/*selected*/ ctx[1]].content
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 16, 0, 268);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, t);
    			mount_component(tabarea, div, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*tabs, selected, tabClick*/ 7) {
    			...
    			if (dirty & /*tabs, selected*/ 3) tabarea_changes.content = /*tabs*/ ctx[0][/*selected*/ ctx[1]].content;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const selection_handler = e => tabClick(e.detail);
    	...
    	return [tabs, selected, tabClick, selection_handler];
    }

    class Tabs extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { tabs: 0 });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$3, 17, 0, 377);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
