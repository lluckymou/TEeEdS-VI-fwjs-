var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	tabbutton = new TabButton({
    			props: {
    				id: /*i*/ ctx[6],
    				name: /*tab*/ ctx[4].name,
    				selected: /*selected*/ ctx[0] === /*i*/ ctx[6]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*selected*/ 1) tabbutton_changes.selected = /*selected*/ ctx[0] === /*i*/ ctx[6];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:4) {#each tabs as tab, i}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	tabarea = new TabArea({
    			props: {
    				content: /*tabs*/ ctx[1][/*selected*/ ctx[0]].content
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*selected*/ 1) tabarea_changes.content = /*tabs*/ ctx[1][/*selected*/ ctx[0]].content;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [selected, tabs, tabClick, selection_handler];
    }
